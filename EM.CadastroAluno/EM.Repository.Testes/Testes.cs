...
namespace EM.Repository.Testes
{
    ...
    public class Testes
    {
        ...
        public void Adicionar_Um_Aluno_Existente_No_Repositorio()
        {
            ...
            var exception = Assert.Throws<Exception>(() => repositorioAluno.Add(aluno));
        ...
        public void Remover_Um_Aluno_Do_Repositorio()
        {
            ...
            var exception = Assert.Throws<Exception>(() => repositorioAluno.GetByMatricula(aluno.Matricula));
        ...
        public void Remover_Um_Aluno_Inexistente_Do_Repositorio()
        {
            ...
            var exception = Assert.Throws<Exception>(() => repositorioAluno.Remove(aluno));
        ...
        public void Atualizar_Aluno_Inexistente_Do_Repositorio()
        {
            ...
            var exception = Assert.Throws<Exception>(() => repositorioAluno.Update(alunoAux));
            Assert.Equal("Aluno não encontrado!", exception.Message);
        }
        ...
        public void Retornar_Todos_Os_Alunos_Do_Repositorio_Vazio()
        {
            ...
            var exception = Assert.Throws<Exception>(() => repositorioVazio.GetAll());
        ...
        public void Retornar_Aluno_Do_Repositorio()
        {
            ...
            var alunos = repositorioAluno.Get(aluno => aluno.Matricula == 201800774 || aluno.Nome.Contains("Maria"));
        ...
        public void Pega_Aluno_Por_Matricula_Inexistente_No_Repositorio_Vazio()
        {
            ...
            var exception = Assert.Throws<Exception>(() => repositorioAluno.GetByMatricula(5551));
            Assert.Equal("Não existe nenhum aluno com essa matrícula!", exception.Message);
        }
        ...
        public void Pega_Aluno_Por_Parte_Nome_No_Repositorio()
        {
            ...
            var alunos = repositorioAluno.Get(a => a.Nome.Contains("Silva"));
        ...
        public void Pega_Aluno_Inexistente_Por_Parte_Nome_No_Repositorio()
        {
            ...
            var exception = Assert.Throws<Exception>(() => repositorioAluno.GetByContendoNoNome("José"));
